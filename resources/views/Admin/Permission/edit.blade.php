...
@section('content')
    <form action="{{ route('admin.permission.update',['id'=>$role->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="display_name">{{$role->display_name}}</textarea>
                        @error('display_name')
                            <span style="color: red">{{ $message }}</span>
                        @enderror
                    </div>
                                        ...
                                        <div class="card-body text-dark col-md-3">
                                            <h5 class="card-title">
                                                <label for="">
                                                    ...
                                                    {{ $pemissionsChecked->contains('id', $permissionChildItem->id) ? 'checked' : '' }}
