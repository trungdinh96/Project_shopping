            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <img src="{{ $product->feature_image_path }}" alt="" width="150">
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <img src="{{ $productImages->image_path }}" alt="" width="100">
                                    </div>
                                    @endforeach
                ...
                <div class="col-md-10">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control tinymce_editor_init" id="exampleFormControlTextarea1" rows="12" name="content">{{ $product->name }}</textarea>
                    </div>
                </div>
                <div class="col-md-12">
